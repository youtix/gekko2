...
import { TRADE_COMPLETED_EVENT } from '../plugin.const';
...
describe('TradingAdvisor', () => {
  ...
  describe('relay functions', () => {
    ...
    it('should emit TRADE_COMPLETED_EVENT in relayTradeCompleted', () => {
      const payload = { trade: 'completed' };
      advisor['relayTradeCompleted'](payload);
      expect(advisor['deferredEmit']).toHaveBeenCalledExactlyOnceWith(
