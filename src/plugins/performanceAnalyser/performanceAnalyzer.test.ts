...
describe('PerformanceAnalyzer', () => {
  ...
  describe('onPortfolioValueChange', () => {
    ...
    it.each`
      initialBalance | eventBalance | expectedStartBalance | expectedBalance
      ${undefined}   | ${1000}      | ${1000}              | ${1000}
      ${500}         | ${1500}      | ${500}               | ${1500}
    `(
      'sets start.balance and balance correctly when initialBalance is $initialBalance and event.balance is $eventBalance',
      ({ initialBalance, eventBalance, expectedStartBalance, expectedBalance }) => {
        if (!isNil(initialBalance)) {
          analyzer.start.balance = initialBalance;
        }
