...
import { DummyCentralizedExchangeConfig, DummyInternalOrder, DummyOrderSide } from './dummy-centralized-exchange.types';
import {
  DUMMY_DEFAULT_LIMITS,
  DUMMY_DEFAULT_PORTFOLIO,
  DUMMY_DEFAULT_TICKER,
} from './dummy-centralized-exchange.const';

export class DummyCentralizedExchange extends CentralizedExchange {
  private readonly config: DummyCentralizedExchangeConfig;
