...
describe('SMMA', () => {
  ...
  `(
    'should correctly calculate SMMAs with weight 2 when candle is $candle',
    ({ candle, expected }) => {
  ...
  const smma12 = new SMMA({ weight: 12 });
  it.each`
    candle           | expected
    ${{ close: 81 }} | ${0}
    ${{ close: 24 }} | ${0}
  ...
  `(
    'should correctly calculate SMMAs with weight 12 and $candle candle',
    ({ candle, expected }) => {
  ...
  const smma26 = new SMMA({ weight: 26 });
  it.each`
    candle           | expected
    ${{ close: 81 }} | ${0}
    ${{ close: 24 }} | ${0}
  ...
  `(
    'should correctly calculate SMMAs with weight 26 and $candle candle',
    ({ candle, expected }) => {
